...
1. Having a duplicate version of the armature, with the pose applied to be the rest pose, so one can attach the object to this duplicate armature to get automatic deformations (can unparent and delete the duplicate armature after)
